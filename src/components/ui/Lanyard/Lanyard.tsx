...
// Using the site logo for the card
import logoPng from '/us_executive_logo.png'; 
...
export default function Lanyard({ position = [0, 0, 20], gravity = [0, -40, 0], fov = 20, transparent = true }) {
  ...
  return (
    <div className="lanyard-wrapper hidden lg:flex">
      <Canvas
...
function Band({ maxSpeed = 50, minSpeed = 0, isMobile = false }) {
  ...
  const cardTexture = useTexture(logoPng);
