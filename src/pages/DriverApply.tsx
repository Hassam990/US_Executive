...
export function DriverApply() {
    ...
    return (
        <div className="min-h-screen bg-black pt-24 md:pt-32 pb-20 px-4 md:px-6 relative overflow-hidden">
            <div className="max-w-2xl mx-auto relative z-10">
                <div className="text-center mb-8 md:mb-12 space-y-4">
                    <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter italic">Drive with Us</h1>
                    <p className="text-pink-500 font-bold uppercase tracking-[0.2em] text-[10px] md:text-sm">Join the US Executive Fleet</p>
                </div>

                <div className="bg-white/5 backdrop-blur-xl border border-white/10 rounded-[2rem] md:rounded-[2.5rem] p-6 md:p-12 shadow-[0_20px_50px_rgba(0,0,0,0.5)]">
                    <form onSubmit={handleSubmit} className="space-y-8">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="relative">
                                    ...
                                    <Input
                                        ...
                                        className="bg-black/40 border-white/10 h-14 pl-12 rounded-2xl text-white focus:border-pink-500 transition-all font-medium text-base"
                                        value={formData.name}
                        ...
                        <div className="space-y-2">
                            ...
                            <Textarea
                                ...
                                className="bg-black/40 border-white/10 min-h-[120px] rounded-2xl text-white focus:border-pink-500 transition-all font-medium p-4 resize-none text-base"
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                ...
                                <Input
                                    ...
                                    className="bg-black/40 border-white/10 h-14 pl-12 rounded-2xl text-white focus:border-pink-500 transition-all font-medium pt-3 text-base"
